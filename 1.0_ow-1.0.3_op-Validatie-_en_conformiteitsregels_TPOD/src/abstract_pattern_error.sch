...
<sch:pattern xmlns:sch="http://purl.oclc.org/dsdl/schematron" id="abstractPatternError"
    abstract="true">
    <sch:rule context="$context">
        <sch:assert test="($businessRuleGroup and $CONDITION) or not($businessRuleGroup)" role="error"> 
            ...
            "melding": "Dit is niet het geval bij <sch:value-of select="$nameidf"/>: <sch:value-of
                select="$idf"/>" 
            }, 
        </sch:assert>
    </sch:rule>
