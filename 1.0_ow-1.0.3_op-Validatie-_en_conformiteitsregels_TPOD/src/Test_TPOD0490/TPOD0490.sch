...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2"
    ...
    <sch:let name="OVi" value="'/join/id/stop/regelingtype_006'"/>
    <!-- Omgevingsvisie -->
    <sch:let name="PB" value="'/join/id/stop/regelingtype_007'"/>
    <!-- Projectbesluit -->
    <sch:let name="I" value="'/join/id/stop/regelingtype_008'"/>
    <!-- Instructie -->
    <sch:let name="VR" value="'/join/id/stop/regelingtype_009'"/>
    <!-- Voorbeschermingsregels -->
    <sch:let name="P" value="'/join/id/stop/regelingtype_010'"/>
    <!-- Programma -->
    <sch:let name="RI" value="'/join/id/stop/regelingtype_011'"/>
    ...
    <sch:let name="omgevingsplan-en-waterschap"
    ...
    <sch:let name="allen"
        value="
            ...
            $SOORT_REGELING = $RI
            "/>
    <sch:let name="allen-behalve-rijk"
        value="
            $SOORT_REGELING = $OP or
            $SOORT_REGELING = $OV or
            $SOORT_REGELING = $WV or
    ...
    <sch:let name="regelstructuur"
        value="
            ...
            $SOORT_REGELING = $VR
            "/>
    <sch:let name="vrijetekststructuur"
        value="
            $SOORT_REGELING = $OVi or
            $SOORT_REGELING = $PB or
            $SOORT_REGELING = $I or
