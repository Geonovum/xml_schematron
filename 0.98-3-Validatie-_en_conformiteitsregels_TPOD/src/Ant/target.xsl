...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">TDOP_0460</xsl:attribute>
            <xsl:attribute name="name">TDOP_0460</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
   ...
   <!--PATTERN TDOP_0460-->
   <!--RULE -->
   <xsl:template match="//tekst:Titel/tekst:Kop[lower-case(tekst:Label) ne 'titel']"
                 priority="1000"
                 mode="M25">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="//tekst:Titel/tekst:Kop[lower-case(tekst:Label) ne 'titel']"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text> 
                TDOP_0410: Een Titel moet worden geduid met de label Titel. Betreft label: <xsl:text/>
