    ...
    <sch:pattern id="TDOP_0500">
        <sch:rule context="//tekst:Lichaam/Hoofdstuk">
            ...
            <sch:assert test="($APPLICABLE and $CONDITION) or not($APPLICABLE)"> 
                TDOP_0500: Afdelingen moeten oplopend worden genummerd in Arabische cijfers. (betreft hoofdstukken, afdelingen):  <xsl:value-of select="$hoofdstuk"/>, <xsl:value-of select="$volgorde"/></sch:assert>
        </sch:rule>
    </sch:pattern>
